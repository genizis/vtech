                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <a href="<?php echo base_url() ?>metodo-pagamento/novo-metodo-pagamento" type="button"
                                    class="btn btn-info link-load"><i class="fas fa-plus-circle"></i> Novo Método de Pagamento</a>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <form class="mb-0 needs-validation" novalidate
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td scope="row" ><a class="text-dark link-load"
                                                            href="<?= base_url("metodo-pagamento/editar-metodo-pagamento/{$metodo_pagamento->cod_metodo_pagamento}") ?>"><?= $metodo_pagamento->cod_metodo_pagamento ?> - <?= $metodo_pagamento->nome_metodo_pagamento ?></a>
                                                    </td>
                                                    <td scope="row"><?php if($metodo_pagamento->cod_conta != null) echo $metodo_pagamento->cod_conta . " - " . $metodo_pagamento->nome_conta; ?></td>
                                                    <td class="text-center">
                                                        <?php if($metodo_pagamento->ativo == 1) {
                                    ...
                                    <div class="text-center text-muted">
                                        <p class="font-italic mt-3">Nenhum método de pagamento encontrado</p>
                                    </div>
                                    <?php } ?>
                                </form>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Confirma eliminação dos métodos de pagamento selecionados?
            </div>
