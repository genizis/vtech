                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="btn-group btn-block" data-toggle="buttons">
                                                <label class="btn btn-outline-primary">
                                                    <input type="radio" id="radioAtivo" name="Ativo" value="1" <?php if ($fornecedor->ativo == 1) echo "checked";  ?>> Ativa
                                                </label>
                                                <label class="btn btn-outline-primary">
                                                    <input type="radio" id="radioInativo" name="Ativo" value="2" <?php if ($fornecedor->ativo == 2) echo "checked";  ?>> Inativa
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group col-md-3">
											...
											<div class="btn-group btn-block" data-toggle="buttons">
												<label class="btn btn-outline-primary">
													...
													<?php if($fornecedor->tipo_pessoa == '1') echo 'checked'; ?>> Jurídica
												</label>
												<label class="btn btn-outline-primary">
													<input type="radio" id="radioFisica" name="TipoPessoa" value="2"
													<?php if($fornecedor->tipo_pessoa == '2') echo 'checked'; ?>> Física
												</label>
                                                <label class="btn btn-outline-primary">
													<input type="radio" id="radioEstrangeira" name="TipoPessoa" value="3"
													<?php if($fornecedor->tipo_pessoa == '3') echo 'checked'; ?>> Estrangeira
												</label>
											</div> 
										</div>
                                        <div class="form-group col-md-5">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" class="form-control" id="inputCPFCNPJ"
                                                    name="CnpjCpf" value="<?= $fornecedor->cnpj_cpf ?>">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select id="inputContribuinteICMS" name="ContribuinteICMS" data-style="btn-input-primary"
                                                ...
                                                <option value="9" <?php if($fornecedor->tipo_contrib_icms == 9) echo "selected"; ?>>Não Contribuinte</option>
                                                <option value="1" <?php if($fornecedor->tipo_contrib_icms == 1) echo "selected"; ?>>Contribuinte</option>
                                                <option value="2" <?php if($fornecedor->tipo_contrib_icms == 2) echo "selected"; ?>>Contribuinte Isento</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputIE">Inscrição Estadual</label>
                                            <input type="text" class="form-control" id="inputIE"
                                                name="IE" value="<?= $fornecedor->insc_estadual ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputIM">Inscrição Municipal</label>
                                            <input type="text" class="form-control" id="inputIM"
                                                name="IM" value="<?= $fornecedor->insc_municipal ?>">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="inputCEP"
                                                 name="CEP" value="<?= $fornecedor->cep?>" data-mask="00000-000">
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="inputNumero"
                                                name="Numero" value="<?= $fornecedor->numero?>">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="inputComplemento"
                                                name="Complemento" value="<?= $fornecedor->complemento ?>">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control selectpicker show-tick" data-live-search="true"
                                                title=" " id="inputPais" name="Pais" <?php if($fornecedor->tipo_pessoa != 3 || $fornecedor->cod_cidade != 9999999) echo "disabled"; ?>>
                                                <?php foreach($lista_pais as $key_pais => $pais) { ?>
                                                <option value="<?= $pais->bacen ?>"
                                                    <?php if($fornecedor->cod_pais == $pais->bacen) echo "selected"; ?>>
                                                    <?= $pais->nome_pt ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
