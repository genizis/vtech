                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <a href="<?php echo base_url() ?>vendedor/novo-vendedor" type="button"
                                    class="btn btn-info link-load"><i class="fas fa-plus-circle"></i> Novo Vendedor</a>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <form action="<?= base_url('vendedor/excluir-vendedor') ?>" method="POST" id="formDelete" class="mb-0 needs-validation" novalidate>
                                    ...
                                    <div class="text-center text-muted">
                                        <p class="font-italic mt-3">Nenhum vendedor encontrado</p>
                                    </div>
                                    <?php } ?>
                                </form>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Confirma eliminação dos vendedores selecionados?
            </div>
