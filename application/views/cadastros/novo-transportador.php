...
<section>
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Novo Transportador</li>
        </ol>
    </div>
</section>
                                ...
                                <form action='novo-transportador' method='post' class="mb-0 needs-validation" novalidate>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputNomeTransportador"
                                                name="NomeTransportador" value="<?= set_value('NomeTransportador'); ?>" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control selectpicker show-tick" data-live-search="true"
                                                title="Selecione o País" id="inputPais" name="Pais" disabled>
