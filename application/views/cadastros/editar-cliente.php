                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <form action="<?= base_url("cliente/editar-cliente/{$cliente->cod_cliente}") ?>"
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="btn-group btn-block" data-toggle="buttons">
                                                <label class="btn btn-outline-primary">
                                                    <input type="radio" id="radioAtivo" name="Ativo" value="1" <?php if ($cliente->ativo == 1) echo "checked";  ?>> Ativa
                                                </label>
                                                <label class="btn btn-outline-primary">
                                                    <input type="radio" id="radioInativo" name="Ativo" value="2" <?php if ($cliente->ativo == 2) echo "checked";  ?>> Inativa
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group col-md-3">
											...
											<div class="btn-group btn-block" data-toggle="buttons">
                                                ...
                                                <label class="btn btn-outline-primary">
													...
													<?php if($cliente->tipo_pessoa == '3') echo 'checked'; ?>> Estrangeira
												</label>
											</div> 
										</div>
                                        <div class="form-group col-md-5">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label for="inputContatoComercial">Contato Comercial</label>
                                            <input type="text" class="form-control" id="inputContatoComercial"
                                                name="ContatoComercial" value="<?= $cliente->contato_comercial ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputTelComercial">Telefone Comercial</label>
                                            <input type="text" class="form-control" id="inputTelComercial"
                                                name="TelComercial" value="<?= $cliente->tel_comercial ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputEmailComercial">E-mail Comercial</label>
                                            <input type="text" class="form-control" id="inputEmailComercial"
                                                name="EmailComercial" value="<?= $cliente->email_comercial ?>">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label for="inputContatoFinanceiro">Contato Financeiro</label>
                                            <input type="text" class="form-control" id="inputContatoFinanceiro"
                                                name="ContatoFinanceiro" value="<?= $cliente->contato_financeiro ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputTelFinanceiro">Telefone Financeiro</label>
                                            <input type="text" class="form-control" id="inputTelFinanceiro"
                                                name="TelFinanceiro" value="<?= $cliente->tel_financeiro ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputEmailFinanceiro">E-mail Financeiro</label>
                                            <input type="text" class="form-control" id="inputEmailFinanceiro"
                                                name="EmailFinanceiro" value="<?= $cliente->email_financeiro ?>">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control selectpicker show-tick" data-live-search="true"
                                                title=" " id="inputPais" name="Pais" <?php if($cliente->tipo_pessoa != 3 || $cliente->cod_cidade != 9999999) echo "disabled"; ?>>
                                                <?php foreach($lista_pais as $key_pais => $pais) { ?>
                                                <option value="<?= $pais->bacen ?>"
                                                    <?php if($cliente->cod_pais == $pais->bacen) echo "selected"; ?>>
                                                    <?= $pais->nome_pt ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
