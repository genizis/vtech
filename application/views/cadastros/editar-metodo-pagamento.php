                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="btn-group btn-block" data-toggle="buttons">
                                                <label class="btn btn-outline-primary">
                                                    <input type="radio" id="radioAtivo" name="Ativo" value="1" <?php if ($metodo_pagamento->ativo == 1) echo "checked";  ?>> Ativa
                                                </label>
                                                <label class="btn btn-outline-primary">
                                                    <input type="radio" id="radioInativo" name="Ativo" value="2" <?php if ($metodo_pagamento->ativo == 2) echo "checked";  ?>> Inativa
                                                </label>
                                            </div>
                                        </div>
                                    </div>
