                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <a href="<?php echo base_url() ?>conta/nova-conta" type="button"
                                    class="btn btn-info link-load"><i class="fas fa-plus-circle"></i> Nova Conta</a>
                            ...
                            <div class="col-md-12">
                                ...
                                <form class="mb-0 needs-validation" novalidate
                                    ...
                                    <div class="text-center text-muted">
                                        <p class="font-italic mt-3">Nenhum conta encontrada</p>
                                    </div>
                                    <?php } ?>
                                </form>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Confirma eliminação das contas selecionadas?
            </div>
