                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <a href="<?php echo base_url() ?>tipo-produto/novo-tipo-produto" type="button"
                                    class="btn btn-info link-load"><i class="fas fa-plus-circle"></i> Novo Tipo de Produto</a>
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="<?= base_url('tipo-produto/excluir-tipo-produto') ?>" method="POST"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td scope="row"><a class="text-dark link-load"
                                                            href="<?= base_url("tipo-produto/editar-tipo-produto/{$tipoProduto->cod_tipo_produto}") ?>"><?= $tipoProduto->nome_tipo_produto ?></a></td>
                                                    <td>
                                    ...
                                    <div class="text-center text-muted">
                                        <p class="font-italic mt-3">Nenhum tipo de produto encontrado</p>
                                    </div>
                                    <?php } ?>
                                </form>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Confirma eliminação dos tipos de produto selecionados?
            </div>
