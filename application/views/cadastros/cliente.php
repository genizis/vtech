                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <a href="<?php echo base_url() ?>cliente/novo-cliente" type="button"
                                    class="btn btn-info link-load"><i class="fas fa-plus-circle"></i> Novo Cliente</a>
                                ...
                                <a href="<?php echo base_url() ?>cliente/importar-cliente" type="button"
                                    class="btn btn-outline-secondary" hidden><i class="fas fa-file-import"></i> Importar Clientes</a>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <form action="<?= base_url('cliente/excluir-cliente') ?>" method="POST" id="formDelete" class="mb-0 needs-validation" novalidate>
                                                    ...
                                                    <td>
                                                        <div class="checkbox text-center">
                                                            <input name="excluir_todos[]" type="checkbox"
                                                                value="<?= $cliente->cod_cliente ?>" <?php if($cliente->count_pedido > 0 || $cliente->count_titulo > 0) echo "disabled"; ?>/>
                                                        </div>
                                                    </td>
                                                    <td scope="row">
                                                        <a class="link-load text-dark"
                                                            href="<?= base_url("cliente/editar-cliente/{$cliente->cod_cliente}") ?>">                                                            
                                    ...
                                    <div class="text-center text-muted">
                                        <p class="font-italic mt-3">Nenhum cliente encontrado</p>
                                    </div>
                                    <?php } ?>
                                </form>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Confirma eliminação dos clientes selecionados?
            </div>
