        ...
        <div class="row">
            <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <a href="<?= base_url("compras/{$mes_anterior}/{$ano_anterior}") ?>"
                                    ...
                                    <div class="input-group-append">
                                        <a href="<?= base_url("compras/{$mes_seguinte}/{$ano_seguinte}") ?>"
                ...
                <div class="card  mb-3">
                    <h6 class="card-header bg-white text-muted">
                        Compras no ano<br>
                        <span class="font-italic text-size-80">Total comprado</span>
                    </h6>
                    <div class="card-body">
                        <div class="row">
