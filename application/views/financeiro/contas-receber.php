    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <a href="<?= base_url("financeiro/contas-receber/{$mes_anterior}/{$ano_anterior}") ?>" class="btn btn-secondary link-load"><i class="fas fa-angle-left"></i></a>
                                    </div>
                                    <input type="text" class="form-control search text-center filtro-data" value="<?= $descMes ?> de <?= $ano ?>" readonly>
                                    <div class="input-group-append">
                                        <a href="<?= base_url("financeiro/contas-receber/{$mes_seguinte}/{$ano_seguinte}") ?>" class="btn btn-secondary link-load"><i class="fas fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <?php if ($lista_conta != false && $lista_conta_resumida->entrada_proj > 0) { ?>
                    <div class="card  mb-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-borderless table-sm text-dark">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="text-right">Total a receber</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($lista_conta as $key_conta_resumida => $conta) if ($conta->entrada_proj_total > 0) { { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right <?php if ($conta->entrada_proj_total > 0) echo "text-teal"; ?>">
                                                            R$ <?= number_format((float) ($conta->entrada_proj_total), 2, ',', '.') ?>
                                                        </td>
                                                    </tr>
                                            <?php }
                                            } ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url("financeiro/contas-receber/{$mes}/{$ano}") ?>" method="get" class="mb-0 needs-validation" novalidate>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <select class="selectpicker show-tick form-control" multiple data-live-search="true" data-actions-box="true" title="Pagador" data-style="btn-input-primary" name="ClienteFiltro[]">
                                        <?php $chave_cliente = 0;
            ...
            <div class="col-md-8 pl-0">
                <ul class="nav nav-tabs mb-3">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#contas-receber">Contas a Receber</a>
                    </li>
                </ul>
                <div class="card  mb-3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-9">
                                <button data-toggle="modal" data-target="#inserir-titulo" type="button" data-backdrop="static" data-keyboard="false" class="btn btn-outline-info btn-sm"><i class="fas fa-plus-circle"></i> Novo
                                    Título</button>
                            ...
                            <div class="col-md-3">
                                <h4 class="font-italic mb-0 text-right text-teal" id="ValorTotalSel"></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="<?= base_url("financeiro/contas-receber/acao-titulo/{$mes}/{$ano}") ?>" method="POST" id="formAcao" class="mb-0 needs-validation" novalidate>
                                                ...
                                                <?php foreach ($lista_contas_receber as $key_contas_receber => $contas_receber) { ?>
                                                    <tr>
                                                        <td class="align-middle">
                                                            <div class="checkbox text-center">
                                                                <input name="selecionar_todos[]" type="checkbox" value="<?= $contas_receber->cod_movimento_conta ?>" />
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="text-center align-middle"><?= $contas_receber->parcela ?>
                                                        </td>
                                                        <td class="text-right text-teal align-middle" id="ValorTitulo<?= $contas_receber->cod_movimento_conta ?>">
                                                            R$ <?= number_format((float) ($contas_receber->valor_titulo), 2, ',', '.') ?>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
            ...
            <div class="modal-body modal-body-scroll bg-light">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="mb-0 needs-validation" novalidate action="<?= base_url("financeiro/contas-receber/inserir-titulo/{$mes}/{$ano}") ?>" method='post' id='formTitulo'>
                            <div class="card">
                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-row" id="dataConfirmacao" style="display: none">
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label class="control-label" for="inputValorReceber">Valor a
                                                                        Receber</label>
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend">
                                                                            <span class="input-group-text">R$</span>
                                                                        </div>
                                                                        <input type="text" class="form-control" class="form-control" readonly id="inputValorReceber" type="text" name="ValorReceber" data-mask="#.##0,00" data-mask-reverse="true" value="<?= set_value('ValorReceber'); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <div class="modal fade" id="editar-titulo<?= $contas_receber->cod_movimento_conta ?>">
        <div class="modal-dialog modal-xxl" role="document">
            <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h5 class="card-title mb-0">
                                                <strong>
                                                    Título: <?= $contas_receber->cod_movimento_conta ?>
                                                </strong>
                                            </h5>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-right align-middle">
                                                            <?php if ($contas_receber->nome_usuario != null) echo $contas_receber->nome_usuario; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-left align-middle text-muted">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right align-middle">
                                                            <?php
                                                            switch ($contas_receber->origem_movimento) {
                                                                case 2:
                                                                    echo "Compras";
                                                                    break;
                                                                case 3:
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right align-middle">
                                                            <?php
                                                            if ($contas_receber->id_origem != null)
                                                                echo $contas_receber->id_origem;
                                                            else
                                                                echo $contas_receber->cod_movimento_conta;
                                                            ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-right align-middle">
                                                            <?php if ($contas_receber->cod_titulo_rel != null) echo $contas_receber->cod_titulo_rel; ?>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <form class="mb-0 needs-validation" novalidate action="<?= base_url("financeiro/contas-receber/editar-titulo/{$contas_receber->cod_movimento_conta}/{$mes}/{$ano}") ?>" method='post' id='formTitulo<?= $contas_receber->cod_movimento_conta ?>'>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" class="form-control" id="inputValorTitulo<?= $contas_receber->cod_movimento_conta ?>" type="text" name="ValorTitulo" data-mask="#.##0,00" data-mask-reverse="true" value="<?= $contas_receber->valor_titulo ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="selectpicker show-tick form-control" data-live-search="true" data-actions-box="true" title=" " name="CodMetodoPagamento" data-style="btn-input-primary">
                                                            <?php foreach ($lista_metodo_pagamento as $key_metodo_pagamento => $metodo_pagamento) { ?>
                                                                <option value="<?= $metodo_pagamento->cod_metodo_pagamento ?>" <?php if ($metodo_pagamento->cod_metodo_pagamento == $contas_receber->cod_metodo_pagamento) echo "selected"; ?>>
                                                                    <?= $metodo_pagamento->cod_metodo_pagamento ?> -
                                                                    <?= $metodo_pagamento->nome_metodo_pagamento ?>
                                                                </option>
                                                            <?php } ?>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="selectpicker show-tick form-control" data-live-search="true" data-actions-box="true" title=" " name="CodCentroCusto" data-style="btn-input-primary">
                                                            <?php foreach ($lista_centro_custo as $key_centro_custo => $centro_custo) { ?>
                                                                <option value="<?= $centro_custo->cod_centro_custo ?>" <?php if ($centro_custo->cod_centro_custo == $contas_receber->cod_centro_custo) echo "selected"; ?>>
                                                                    <?= $centro_custo->cod_centro_custo ?> -
                                                                    <?= $centro_custo->nome_centro_custo ?>
                                                                </option>
                                                            <?php } ?>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="selectpicker show-tick form-control" data-live-search="true" data-actions-box="true" title=" " name="CodContaContabil" data-style="btn-input-primary">
                                                            <?php foreach ($lista_conta_contabil as $key_conta_contabil => $conta_contabil) { ?>
                                                                <option value="<?= $conta_contabil->cod_conta_contabil ?>" <?php if ($conta_contabil->cod_conta_contabil == $contas_receber->cod_conta_contabil) echo "selected"; ?>>
                                                                    <?= $conta_contabil->cod_conta_contabil ?> -
                                                                    <?= $conta_contabil->nome_conta_contabil ?>
                                                                </option>
                                                            <?php } ?>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="inputConfirmarEdit<?= $contas_receber->cod_movimento_conta ?>" name="Confirmar" value="1" <?php if ($contas_receber->confirmado == 1) echo "checked"; ?>>
                                                            <label class="custom-control-label" for="inputConfirmarEdit<?= $contas_receber->cod_movimento_conta ?>">Confirmar
                                                                Título</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row" id="dataConfirmacao<?= $contas_receber->cod_movimento_conta ?>" style="display: none">
                                                    <div class="form-group col-md-3">
                                                        <label class="control-label" for="inputDataConfirmacao<?= $contas_receber->cod_movimento_conta ?>">Data
                                                            de
                                                            Confirmação <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="inputDataConfirmacao<?= $contas_receber->cod_movimento_conta ?>" name="DataConfirmacao" value="<?= set_value('DataConfirmacao') ?>">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label class="control-label" for="inputValorDescontoTaxas<?= $contas_receber->cod_movimento_conta ?>">Descontos
                                                            e Taxas</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">R$</span>
                                                            </div>
                                                            <input type="text" class="form-control" class="form-control" id="inputValorDescontoTaxas<?= $contas_receber->cod_movimento_conta ?>" type="text" name="ValorDescontoTaxas" data-mask="#.##0,00" data-mask-reverse="true" value="<?= $contas_receber->valor_desc_taxa ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label class="control-label" for="inputValorMultasJustos<?= $contas_receber->cod_movimento_conta ?>">Multas
                                                            e
                                                            Juros</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="text" class="form-control" class="form-control" id="inputValorMultasJustos<?= $contas_receber->cod_movimento_conta ?>" type="text" name="ValorMultasJustos" data-mask="#.##0,00" data-mask-reverse="true" value="<?= $contas_receber->valor_juros_multa ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label class="control-label" for="inputValorReceber<?= $contas_receber->cod_movimento_conta ?>">Valor
                                                            a
                                                            Receber</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="text" class="form-control" class="form-control" readonly id="inputValorReceber<?= $contas_receber->cod_movimento_conta ?>" type="text" name="ValorReceber" data-mask="#.##0,00" data-mask-reverse="true" value="<?= set_value('ValorReceber'); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" form="formTitulo<?= $contas_receber->cod_movimento_conta ?>" <?php if ($contas_receber->ativo == 2) echo "disabled"; ?>><i class="fas fa-save"></i>
                        Salvar</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                </div>
            </div>
...
<script>
    ...
    <?php foreach ($lista_contas_receber as $key_contas_receber => $contas_receber) { ?>
        ...
        $('#inputDataCompetenciaEdit<?= $contas_receber->cod_movimento_conta ?>').datepicker({
            uiLibrary: 'bootstrap4'
        });
