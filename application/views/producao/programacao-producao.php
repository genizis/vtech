                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    R$
                                    <?= number_format((float) ($frente_caixa->total_venda_geral), 2, ',', '.') ?></td>
                                <td
                                    class="text-center <?php if(($frente_caixa->total_venda_geral - $frente_caixa->total_venda_liquido) > 0) echo "text-warning"; ?>">
                                    R$
                                    <?= number_format((float) ($frente_caixa->total_venda_geral - $frente_caixa->total_venda_liquido), 2, ',', '.') ?>
                                </td>
                                <td
                                    class="text-center <?php if($frente_caixa->total_venda_liquido > 0) echo "text-teal"; ?>">
                                    <strong>R$
                                        <?= number_format((float) ($frente_caixa->total_venda_liquido), 2, ',', '.') ?></strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center <?php if($frente_caixa->saldo_inicial > 0) echo "text-teal"; ?>">
                                    R$ <?= number_format((float) ($frente_caixa->saldo_inicial), 2, ',', '.') ?></td>
                            </tr>
                            <tr>
                                <td>Total de Recolhimento</td>
                                <td
                                    class="text-center <?php if($frente_caixa->total_recolhimento > 0) echo "text-danger"; ?>">
                                    R$ <?= number_format((float) ($frente_caixa->total_recolhimento), 2, ',', '.') ?></td>
                            </tr>
                            <tr>
                                <td>Total de Incremento</td>
                                <td
                                    class="text-center <?php if($frente_caixa->total_incremento > 0) echo "text-teal"; ?>">
                                    R$ <?= number_format((float) ($frente_caixa->total_incremento), 2, ',', '.') ?></td>
                            </tr>
                            <tr>
                                <td>Total de Vendas Caixa</td>
                                <td class="text-center <?php if($frente_caixa->total_venda > 0) echo "text-teal"; ?>">R$
                                    <?= number_format((float) ($frente_caixa->total_venda), 2, ',', '.') ?></td>
                            </tr>
                            <tr>
                                <td>Saldo Final do Caixa</td>
                                <td class="text-center text-teal">
                                    <strong>R$
                                        <?= number_format((float) ($frente_caixa->saldo_inicial + $frente_caixa->total_venda + $frente_caixa->total_incremento - $frente_caixa->total_recolhimento), 2, ',', '.') ?><strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center text-teal">R$
                                    <?= number_format((float) ($recebimento->total_venda), 2, ',', '.') ?></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td
                                    ...
                                    R$ <?= number_format((float) ($movimento->valor_movimento), 2, ',', '.') ?>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
