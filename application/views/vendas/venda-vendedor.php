                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 text-center">
                                    <canvas id="graph-vendedor"></canvas>
                                </div>
                            </div>
                            <?php } ?>
                            <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-left limit-text-30"><i
                                                                class="fa fa-circle fa-xs pr-2" style="color: <?= $vendedor->color ?>"></i>
                                                            <?= $vendedor->nome_vendedor ?>
                                                        </td>
                                                        <td class="text-right text-teal">
                                                        R$ <?= number_format((float) ($vendedor->total_vendas + $vendedor->total_frete +
                                                                            $vendedor->total_seguro + $vendedor->outras_despesas - 
                                                                            $vendedor->total_desconto), 2, ',', '.') ?>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right pt-0 <?php if($lista_valores->total_vendas > 0) echo "text-teal"; ?>">
                                        <strong>
                                            R$ <?= number_format((float) ($lista_valores->total_vendas), 2, ',', '.') ?>
                                        </strong>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <select id="inputVendedor" name="vendedor[]" data-style="btn-input-primary" multiple
                                        ...
                                        <?php $chave_vendedor = 0; foreach($lista_vendedor_pesquisa as $key_vendedor => $vendedor) { ?>
            ...
            <div class="col-md-8 pl-0">
                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="movimentacoes-tab" data-toggle="tab" href="#movimentacoes-cliente" role="tab" aria-controls="movimentacoes-cliente" aria-selected="true">Vendas dos Vendedores</a>
                    </li>
                </ul>
                <div class="card  mb-5">
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="movimentacoes-cliente" role="tabpanel" aria-labelledby="movimentacoes-tab">
                                    ...
                                    <table class="table table-bordered table-reporte">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-right align-middle">Valor total</th>
                                                <th scope="col" class="text-right align-middle">Comissão (%)</th>
                                                <th scope="col" class="text-right align-middle">Comissão ($)</th>
                                            </tr>
                                        </thead>
                                        <tbody class="table-sm">
                                            <?php foreach($lista_vendedor_cliente as $key_vendedor_cliente => $vendedor_cliente) { ?>
                                                <tr>
                                                    ...
                                                    <td class="limit-text-40 align-middle align-middle" data-toggle="tooltip" data-placement="bottom" title="<?= $vendedor_cliente->nome_vendedor ?>">
                                                        <a href="#" data-toggle="modal" class="text-dark"
                                                                        data-target="#venda-cliente<?= $vendedor_cliente->cod_faturamento_pedido ?>"><?= $vendedor_cliente->nome_vendedor ?></a><br>
                                                        <span class="badge font-italic text-muted">
                                                        <?php
                                                    ...
                                                    <td class="text-right align-middle <?php if($vendedor_cliente->valor_bruto > 0) echo "text-teal"; ?>">
                                                    R$ <?= number_format((float) ($vendedor_cliente->valor_bruto), 2, ',', '.') ?>
                                                    </td>
                                                    <td class="text-right align-middle">
                                                        <?= number_format((float) ($vendedor_cliente->perc_comissao), 2, ',', '.') ?>%
                                                    </td>
                                                    <td class="text-right align-middle <?php if($vendedor_cliente->total_comissao > 0) echo "text-info"; ?>">
...
<?php foreach ($lista_vendedor_cliente as $key_venda => $venda) { ?>
<div class="modal fade" id="venda-cliente<?= $venda->cod_faturamento_pedido ?>">
                ...
                <div class="row">
                                        ...
                                        <table class="table table-borderless table-sm mb-0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right align-middle">
                                                        <strong><?= $venda->cod_cliente ?> - <?= $venda->nome_cliente ?></strong>
                                                    </td>
                                                </tr>                                                
                                            </tbody>
                                        </table>
                                        <table class="table table-borderless table-sm mb-0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right align-middle">
                                                        <strong><?= $venda->num_pedido_venda ?></strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left align-middle">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right align-middle">
                                                        <?= str_replace('-', '/', date("d-m-Y", strtotime($venda->data_faturamento))) ?> 
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        R$ <?= number_format((float) ($venda->valor_bruto), 2, ',', '.') ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left align-middle ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <strong>
                                                    R$ <?= number_format((float) ($venda->valor_bruto + $venda->valor_frete + $venda->valor_seguro + $venda->outras_despesas -
                                                      $venda->valor_desconto), 2, ',', '.') ?>
                                                </strong>
                                            </td>
                                        </tr>
                                        <?php if($venda->perc_comissao > 0) { ?>
                                        <tr>
                                            <td class="text-left pt-0 text-dark"><strong>TOTAL COMISSÃO</strong></td>
                                            <td
                                                class="text-right pt-0 text-info">
                                                <strong>
                                                    R$ <?= number_format((float) ($venda->total_comissao), 2, ',', '.') ?>
                                                </strong>
                                            </td>
                                        </tr>
                                        <?php } ?>
                    ...
                    <div class="col-md-8 pl-0">
                        <ul class="nav nav-tabs mb-3">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#prod-faturado<?= $venda->cod_faturamento_pedido ?>">Produtos Vendidos</a>
                            </li>
                        </ul>
                        <div class="card">
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="prod-faturado<?= $venda->cod_faturamento_pedido ?>">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php $i = 0; foreach ($lista_vendedor_produto as $key_faturamento_produto => $faturamento_produto) {
                                                                if ($faturamento_produto->cod_faturamento_pedido == $venda->cod_faturamento_pedido) { $i += 1; ?>
                                                            <tr>
...
<script>
    ...
    new Chart(document.getElementById("graph-vendedor"), {
    type: 'doughnut',
    data: {
        labels: <?php echo json_encode($label_vendedor); ?>,
        datasets: [{
            label: "Vendas por vendedor",
            backgroundColor: <?php echo json_encode($color_vendedor); ?>,
            data: <?php echo json_encode($perc_vendedor); ?>
        }]
    },    
    options: {            
        responsive: true,        
