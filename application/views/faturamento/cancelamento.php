...
<section>
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Cancelamento Nota Fiscal</a></li>
        </ol>
    </div>
</section>
                ...
                <div class="card  mb-3">
                  ...
                  $this->session->set_flashdata('sucesso', ''); ?>
                                <form class="mb-0 needs-validation"
                                    action="<?php echo base_url('faturamento/pedido/cancelar-nfe/' . $nf) ?>"
                                    method="POST" id="cancelamentoNFe">
                                    <input type="hidden" value="<?php echo $nf ?>" name="nf_id" />                                    
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputCliente">Motivo do Cancelamento <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="motivo" class="form-control" required rows="6"></textarea>
                                        </div>
                                    </div>
                                    <hr class="mb-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="submit" form="cancelamentoNFe" class="btn btn-danger pull-right"
                                                    name="Opcao" value="salvar"><i class="fa-regular fa-rectangle-xmark"></i>
                                                        Cancelar NF
                                            </button>
