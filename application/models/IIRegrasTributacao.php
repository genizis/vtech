...
class IIRegrasTributacao extends CI_Model{    

    var $table = 'II_regras_tributacao';
    var $tableEstado = 'II_link_estado';
    var $tableProduto = 'II_link_produtos';
    
    var $FKID = 'FKIDRegrasTributacaoII';
